    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-sm">
                <h2 className="text-2xl font-bold text-slate-700 mb-4">Your Profile</h2>
                <input
                    type="text"
                    value={name}
                ...
                <h3 className="text-lg font-bold text-slate-600 mt-6 mb-3">Choose an Avatar Style</h3>
                <p className="text-sm text-slate-500 mb-3 -mt-2">Your unique avatar is generated from your name and the selected style.</p>
                        ...
                        return (
                            <button
                                ...
                                className={`
                                    ...
                                    ${isSelected ? 'ring-2 ring-offset-2 ring-sky-500 bg-sky-100' : 'hover:bg-slate-100'}
                                `}
